...
* データベースの共有。自分のデータだけでなく、他者の情報を共有することができる。

  * ローカルデータベース：自分のデータだけ。(家のタンス)
  * Firebase：他者のデータも入る。(いろんなところから物が集まる倉庫)
...
```swift
//podを入れた時、以前の青いXcodeを開いたまま、新しい白いファイルを開くとエラーが出る。
消して再起動するとなおる。
...
* ローカルデータベースとリモートのデータベースを比較して説明した方がわかりやすい。
  * 他者との情報をシェアできるかどうか。
  * ネットに繋がっていない状態で使えるかどうか。
